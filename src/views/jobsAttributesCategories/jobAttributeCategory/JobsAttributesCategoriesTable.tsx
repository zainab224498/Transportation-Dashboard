...
import { JobsAttributesCategoriesType } from 'src/types/apps/job'
...
interface CellType {
  row: JobsAttributesCategoriesType
}
...
const JobsAttributesCategoriesTable = () => {
  // ** State
  ...
  const staticRows = [
    ...
    {
      id: 4,
      title: 'Static Title 4'
    },
    {
      id: 5,
      title: 'Static Title 5'
    },
    {
      id: 6,
      title: 'Static Title 6'
    }
  ];
  ...
  return (
    <Card>
      ...
      >
        <Typography sx={{ fontWeight: 'bold', fontSize: 20 }}> JOBS ATTRIBUTES CATEGORIES</Typography>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Button
            component={Link}
            variant='contained'
            href='/jobsAttributesCategories/add'
            startIcon={<Icon icon='tabler:plus' />}
          >
            ADD JOB ATTRIBUTE CATEGORY
          </Button>
        </Box>
      </Box>
      <DataGrid
...
export default JobsAttributesCategoriesTable
