...
import { fetchData } from 'src/store/apps/address/city'

// ** Type Imports
import { RootState, AppDispatch } from 'src/store'
import { CitiesType } from 'src/types/apps/address'
...
const CitiesTable = () => {
  ...
  const store = useSelector((state: RootState) => state.city)
  ...
  return (
    <Card>
      ...
      >
        <Typography sx={{ fontWeight: 'bold', fontSize: 20 }}> CITIES</Typography>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Button component={Link} variant='contained' href='/cities/add' startIcon={<Icon icon='tabler:plus' />}>
            ADD CITY
          </Button>
        </Box>
      </Box>
