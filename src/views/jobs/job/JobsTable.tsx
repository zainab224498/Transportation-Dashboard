...
import { JobsType } from 'src/types/apps/job'
...
const JobsTable = () => {
  ...
  return (
    <Card>
      ...
      >
        <Typography sx={{ fontWeight: 'bold', fontSize: 20 }}> JOBS</Typography>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Button component={Link} variant='contained' href='/jobs/add' startIcon={<Icon icon='tabler:plus' />}>
            ADD JOB
          </Button>
        </Box>
      </Box>
