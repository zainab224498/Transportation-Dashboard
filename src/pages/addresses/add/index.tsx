...
const schema = yup.object().shape({
  ...
  latitude: yup
    .number()
    .typeError('Latitude field is required')
    .min(1, obj => showErrors('Latitude', obj.value.length, obj.min))
    .required(),
  longitude: yup
    .number()
    .typeError('Longitude field is required')
    .min(1, obj => showErrors('Longitude', obj.value.length, obj.min))
    .required()
})
